    ...
    <div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
        {sortedEpisodes.map((episode) => (
          <Link key={episode.episodeSlug} href={`/comics/${series.slug}/${episode.episodeSlug}`} className="border rounded-lg overflow-hidden group">
            ...
            <div className="p-3">
              <h3 className="font-semibold truncate group-hover:text-sky-500 transition-colors">{episode.title}</h3>
